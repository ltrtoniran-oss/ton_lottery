...
export type Lottery$Data = {
    ...
    playerCount: bigint;
    userTicketCounts: Dictionary<Address, number>;
    recentWinners: Dictionary<number, Address>;
    winnerCount: bigint;
}
...
export function storeLottery$Data(src: Lottery$Data) {
    return (builder: Builder) => {
        ...
        b_0.storeDict(src.userTicketCounts, Dictionary.Keys.Address(), Dictionary.Values.Uint(32));
        b_0.storeDict(src.recentWinners, Dictionary.Keys.Uint(32), Dictionary.Values.Address());
...
export function loadLottery$Data(slice: Slice) {
    ...
    const _playerCount = sc_0.loadUintBig(32);
    const _userTicketCounts = Dictionary.load(Dictionary.Keys.Address(), Dictionary.Values.Uint(32), sc_0);
    const _recentWinners = Dictionary.load(Dictionary.Keys.Uint(32), Dictionary.Values.Address(), sc_0);
    const _winnerCount = sc_0.loadUintBig(32);
    return { $$type: 'Lottery$Data' as const, owner: _owner, ticketPrice: _ticketPrice, endTime: _endTime, interval: _interval, players: _players, playerCount: _playerCount, userTicketCounts: _userTicketCounts, recentWinners: _recentWinners, winnerCount: _winnerCount };
}
...
export function loadTupleLottery$Data(source: TupleReader) {
    ...
    const _userTicketCounts = Dictionary.loadDirect(Dictionary.Keys.Address(), Dictionary.Values.Uint(32), source.readCellOpt());
    const _recentWinners = Dictionary.loadDirect(Dictionary.Keys.Uint(32), Dictionary.Values.Address(), source.readCellOpt());
...
export function storeTupleLottery$Data(source: Lottery$Data) {
    ...
    builder.writeCell(source.userTicketCounts.size > 0 ? beginCell().storeDictDirect(source.userTicketCounts, Dictionary.Keys.Address(), Dictionary.Values.Uint(32)).endCell() : null);
    builder.writeCell(source.recentWinners.size > 0 ? beginCell().storeDictDirect(source.recentWinners, Dictionary.Keys.Uint(32), Dictionary.Values.Address()).endCell() : null);
...
async function Lottery_init(owner: Address) {
    const __code = Cell.fromHex('');
...
export const Lottery_errors = {
    ...
    35937: { message: "No players" },
    51754: { message: "Insufficient funds" },
    54571: { message: "Lottery not finished" },
} as const
...
const Lottery_types: ABIType[] = [
    ...
    {"name":"Lottery$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"ticketPrice","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"endTime","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"interval","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"players","type":{"kind":"dict","key":"int","value":"address"}},{"name":"playerCount","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"userTicketCounts","type":{"kind":"dict","key":"address","value":"uint","valueFormat":32}},{"name":"recentWinners","type":{"kind":"dict","key":"uint","keyFormat":32,"value":"address"}},{"name":"winnerCount","type":{"kind":"simple","type":"uint","optional":false,"format":32}}]},
]
...
const Lottery_getters: ABIGetter[] = [
    ...
    {"name":"lastWinners","methodId":104779,"arguments":[],"returnType":{"kind":"dict","key":"uint","keyFormat":32,"value":"address"}},
...
export class Lottery implements Contract {
    ...
    async getLastWinners(provider: ContractProvider) {
        ...
        const result = Dictionary.loadDirect(Dictionary.Keys.Uint(32), Dictionary.Values.Address(), source.readCellOpt());
        return result;
    }
